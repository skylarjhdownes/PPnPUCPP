...
try {
  ...
  vector<char> v4(5);
  for (std::size_t i = 0; i <= v4.size(); ++i) ; cout << "14: Success!\n";

  // 15
  //string s = "Success!\n"; for (int i=0; i<6; ++i) cout << s[i];
  string s5 = "15: Success!\n";
  for (int i = 0; i < 13; ++i) cout << s5[i];
  ...
  int x = 2000;
  char c3 = 'x';
  if (x == 2000) cout << "17: Success!\n";

  // 18
  //string s = "Success!\n"; for (int i=0; i<10; ++i) cout << s[i];
  string s6 = "18: Success!\n";
  for (int i = 0; i < 13; ++i) cout << s6[i];
  ...
  //
  //2x^2 - 3.5x = 4
  //Solutions are fractional, sad.  I wanted to only change one character...
  double x2 = 0;
  double d = 5/(x2 + 2);
  ...
  int i2 = 0;
  while (i2 < 10) ++i2;
  if (9 < i2) cout << "23: Success!\n";

  // 24
  //int x = 4; double d = 5/(x–2); if (d=2*x+0.5) cout << "Success!\n";
  double x3 = 4;
  double d2 = 5/(x3-2);
  if (d2 == (0.5 * x3 + 0.5)) cout << "24: Success!\n";
